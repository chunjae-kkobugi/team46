...
function postLayout(p, sid){
    ...
    <div class="m-2">
        <div class="card shadow-sm post-style">
            ...
            <div class="bg" style="${(p.bgImage==null)? 'background-color: '+p.bgColor : `background-repeat : repeat-y; background-position : center; background-image: url('${realpath}images/postImage/` + p.file.savePath + '/s_' + p.file.saveName + '\');'}"></div>    
